...
async fn main() -> Result<()> {
    ...
    scores.insert("NixOS".to_string(), 0);
    scores.insert("Fedora".to_string(), 0);
    scores.insert("Ubuntu".to_string(), 0);
    scores.insert("blanc".to_string(), 0);
    scores.insert("nul".to_string(), 0);
